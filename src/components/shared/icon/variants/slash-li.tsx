export const SlashLi = ({ className = '' }) => {
  return (
    <svg
      className={className}
      width={24}
    ...
    >
      ...
      <path d='M4.9 19.75c-.19 0-.38-.07-.53-.22a.754.754 0 0 1 0-1.06l14-14c.29-.29.77-.29 1.06 0s.29.77 0 1.06l-14 14c-.15.15-.34.22-.53.22' />
    </svg>
  );
};
