export const ReceiptLi = ({ className = '' }) => {
  return (
    ...
    >
      ...
      <path d='M16 7.75H8c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h8c.41 0 .75.34.75.75s-.34.75-.75.75m-1 4H9c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h6c.41 0 .75.34.75.75s-.34.75-.75.75' />
    </svg>
  );
};
