export const ForbiddenLi = ({ className = '' }) => {
  return (
    <svg
      className={className}
      width={24}
    ...
    >
      ...
      <path d='M8.5 16.25c-.19 0-.38-.07-.53-.22a.754.754 0 0 1 0-1.06l7-7c.29-.29.77-.29 1.06 0s.29.77 0 1.06l-7 7c-.15.15-.34.22-.53.22' />
      <path d='M15.5 16.25c-.19 0-.38-.07-.53-.22l-7-7a.754.754 0 0 1 0-1.06c.29-.29.77-.29 1.06 0l7 7c.29.29.29.77 0 1.06-.15.15-.34.22-.53.22' />
    </svg>
  );
};
